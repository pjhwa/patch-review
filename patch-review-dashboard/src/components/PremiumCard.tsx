                    ...
                    {stages ? (
                        <div className="grid grid-cols-3 gap-2 mt-2 mb-4">
                            <div className="flex flex-col">
                                <span className="text-xs text-white/40 mb-1">Collected</span>
                            ...
                            <div className="flex flex-col border-l border-white/5 pl-2">
                                <span className="text-xs text-white/40 mb-1">Preprocessed</span>
                        ...
                        <div className="text-xs text-white/40 mt-1 mb-4">No data available</div>
                    )}
                </CardContent>
            </Link>
                    ...
                    <div className="flex items-center justify-between gap-2">
                        ...
                        {isReviewCompleted && (
                            <div className="flex items-center gap-1.5 px-2.5 py-1 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 rounded-full shadow-[0_0_10px_rgba(16,185,129,0.1)] relative z-10">
                                ...
                                <span className="text-[10px] font-bold uppercase tracking-wider">Review Completed</span>
                            </div>
                        )}
                    </div>
                </div>
